...
void ui_create_settings_screen() {
  if (ui_SettingsScreen == NULL) {
    ...
    lv_obj_set_style_bg_color(ui_SettingsPanel, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_SettingsPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_align_to(brightnessSlider, ui_DarkmodeLabel,
    ...
    lv_textarea_set_placeholder_text(ui_SettingsCityEdit,
    ...
    lv_obj_set_size(ui_SettingsCityLabel, LV_SIZE_CONTENT,
                    LV_SIZE_CONTENT); /// 1
    ...
    lv_obj_set_style_text_font(ui_SettingsCityLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_SettingsCityLabel, LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui_SettingsSSIDLabel, LV_SIZE_CONTENT,
                    LV_SIZE_CONTENT); /// 1
    ...
    lv_obj_set_style_text_font(ui_SettingsSSIDLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui_SettingsPasswordEdit, 180,
    ...
    lv_obj_set_size(ui_SettingsPasswordLabel, LV_SIZE_CONTENT,
                    LV_SIZE_CONTENT); /// 1
    lv_obj_set_pos(ui_SettingsPasswordLabel, 20,
    ...
    lv_obj_set_style_text_font(ui_SettingsPasswordLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_SettingsAPLabel, &montserrat_18,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui_SettingsHomeButtonLabel,
                                LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_add_event_cb(ui_DarkmodeSwitch, ui_event_DarkmodeSwitch,
                        LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_SettingsCityEdit, ui_event_SettingsCityEdit,
                        LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_SettingsSSIDEdit, ui_event_SettingsSSIDEdit,
                        LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_SettingsPasswordEdit, ui_event_SettingsPasswordEdit,
                        LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_SettingsHomeButton, ui_event_SettingsHomeButton,
                        LV_EVENT_ALL, NULL);
  }
}
void ui_delete_settings_screen() {
  if (ui_SettingsScreen != NULL) {
    ...
    lv_obj_remove_event_cb(ui_SettingsPasswordEdit,
                           ui_event_SettingsPasswordEdit);
...
void ui_create_keyboard(lv_obj_t *target) {
  if (ui_SettingsKeyboard == NULL) {
    ...
    lv_obj_add_event_cb(ui_SettingsKeyboard, ui_event_SettingsKeyboard,
                        LV_EVENT_ALL, NULL);
  } else {
    lv_keyboard_set_textarea(ui_SettingsKeyboard, target);
  }
...
void ui_event_SettingsCityEdit(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_FOCUSED || event_code == LV_EVENT_CLICKED) {
    ...
    lv_obj_scroll_to_y(ui_SettingsPanel,
...
void ui_event_DarkmodeSwitch(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_VALUE_CHANGED) {
    if (lv_obj_has_state(target, LV_STATE_CHECKED)) {
      ...
      lv_obj_set_style_text_color(ui_SettingsButtonLabel, lv_color_black(),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_shadow_opa(ui_SettingsButton, 0,
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_shadow_opa(ui_AlarmWorkingDayButton, 0,
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_shadow_opa(ui_AlarmWeekendDayButton, 0,
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_shadow_opa(ui_AlarmOneOffButton, 0,
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_text_color(ui_AlarmWorkingDayButtonLabel,
                                  lv_color_black(),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_text_color(ui_AlarmWeekendDayButtonLabel,
                                  lv_color_black(),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_text_color(ui_AlarmOneOffButtonLabel, lv_color_black(),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
    } else {
      lv_disp_t *dispp = lv_disp_get_default();
      lv_theme_t *theme = lv_theme_default_init(
      ...
      lv_disp_set_theme(dispp, theme);
      lv_obj_set_style_text_color(ui_SettingsButtonLabel, lv_color_white(),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_text_color(ui_AlarmWorkingDayButtonLabel,
                                  lv_color_white(),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_text_color(ui_AlarmWeekendDayButtonLabel,
                                  lv_color_white(),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_text_color(ui_AlarmOneOffButtonLabel, lv_color_white(),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
    }
  }
}
...
void ui_create_alarm_modal_panel(lv_obj_t *target_label) {
  ...
  if (ui_AlarmModalPanel == NULL) {
    ...
    lv_roller_set_options(ui_AlarmHourRoller, hour_count,
    ...
    lv_obj_set_style_text_font(ui_AlarmHourRoller, &montserrat_18,
                               LV_PART_MAIN);

    ui_AlarmMinuteRoller = lv_roller_create(ui_AlarmModalPanel);
    lv_roller_set_options(ui_AlarmMinuteRoller, minute_count,
                          LV_ROLLER_MODE_INFINITE);
    lv_obj_set_size(ui_AlarmMinuteRoller, 90, 110);
    lv_obj_align_to(ui_AlarmMinuteRoller, ui_AlarmHourRoller,
                    LV_ALIGN_BOTTOM_LEFT, 83, 18);
    lv_obj_set_style_text_font(ui_AlarmMinuteRoller, &montserrat_18,
                               LV_PART_MAIN);
    ...
    lv_obj_set_size(ui_AlarmModalCancelButtonLabel, LV_SIZE_CONTENT,
                    LV_SIZE_CONTENT); /// 1
    lv_obj_set_align(ui_AlarmModalCancelButtonLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_AlarmModalCancelButtonLabel, "Cancel");
    lv_obj_set_style_text_font(ui_AlarmModalCancelButtonLabel, &montserrat_18,
                               LV_PART_MAIN);

    ui_AlarmModalOkButton = lv_btn_create(ui_AlarmModalPanel);
    lv_obj_set_size(ui_AlarmModalOkButton, 90, 45);
    lv_obj_align_to(ui_AlarmModalOkButton, ui_AlarmModalCancelButton,
                    LV_ALIGN_BOTTOM_LEFT, 85, 10);

    ui_AlarmModalOkButtonLabel = lv_label_create(ui_AlarmModalOkButton);
    lv_obj_set_size(ui_AlarmModalOkButtonLabel, LV_SIZE_CONTENT,
                    LV_SIZE_CONTENT); /// 1
    lv_obj_set_align(ui_AlarmModalOkButtonLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_AlarmModalOkButtonLabel, "OK");
    lv_obj_set_style_text_font(ui_AlarmModalOkButtonLabel, &montserrat_18,
                               LV_PART_MAIN);

    lv_obj_add_event_cb(ui_AlarmModalCancelButton,
                        ui_event_AlarmModalCancelButton, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_AlarmModalOkButton, ui_event_AlarmModalOkButton,
...
void ui_delete_alarm_modal_panel() {
  if (ui_AlarmDummyPanel != NULL) {
    lv_obj_remove_event_cb(ui_AlarmModalCancelButton,
                           ui_event_AlarmModalCancelButton);
...
void ui_event_AlarmModalOkButton(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_CLICKED) {
    lv_label_set_text_fmt(e->user_data, "%02i:%02i",
                          lv_roller_get_selected(ui_AlarmHourRoller),
                          lv_roller_get_selected(ui_AlarmMinuteRoller));
    ui_delete_alarm_modal_panel();
  }
}
...
void ui_event_AlarmScreen(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_GESTURE &&
    ...
    lv_obj_set_parent(ui_SettingsButton,
                      lv_obj_get_child(ui_AnalogClockScreen, 0));
    lv_obj_set_parent(ui_BatteryLabel,
                      lv_obj_get_child(ui_AnalogClockScreen, 0));
...
void ui_event_WeatherScreen(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_GESTURE &&
      lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
    lv_obj_set_parent(ui_SettingsButton,
                      lv_obj_get_child(ui_DigitalClockScreen, 0));
    lv_obj_set_parent(ui_BatteryLabel,
                      lv_obj_get_child(ui_DigitalClockScreen, 0));
    ui_screen_change(ui_DigitalClockScreen, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 500,
                     0);
  }
}
...
void ui_Alarm_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_AlarmPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_size(ui_AlarmWorkingDayLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  ...
  lv_obj_align_to(ui_AlarmOneOffLabel, ui_AlarmWeekendDayLabel,
                  LV_ALIGN_OUT_BOTTOM_LEFT, 0, 40);
  ...
  lv_obj_align_to(ui_AlarmOneOffButton, ui_AlarmWeekendDayButton,
                  LV_ALIGN_OUT_BOTTOM_MID, 0, 20);
  lv_obj_set_style_bg_opa(ui_AlarmOneOffButton, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_AlarmOneOffButtonLabel = lv_label_create(ui_AlarmOneOffButton);
  lv_obj_set_size(ui_AlarmOneOffButtonLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  lv_obj_set_align(ui_AlarmOneOffButtonLabel, LV_ALIGN_CENTER);
  lv_label_set_text(ui_AlarmOneOffButtonLabel, "12:03");
  lv_obj_set_style_text_font(ui_AlarmOneOffButtonLabel, &montserrat_18,
                             LV_PART_MAIN);

  ui_AlarmOneOffSwitch = lv_switch_create(ui_AlarmPanel);
  lv_obj_set_size(ui_AlarmOneOffSwitch, 50, 25);
  lv_obj_align_to(ui_AlarmOneOffSwitch, ui_AlarmWeekendDaySwitch,
                  LV_ALIGN_OUT_BOTTOM_MID, 0, 35);

  lv_obj_add_event_cb(ui_AlarmWorkingDayButton, ui_event_WorkingDayButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_AlarmWeekendDayButton, ui_event_WeekendButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_AlarmOneOffButton, ui_event_OneOffButton, LV_EVENT_ALL,
                      NULL);
...
void ui_AnalogClock_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_AnalogClockPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_AnalogClockPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(ui_AnalogClockScreen, ui_event_AnalogClockScreen,
                      LV_EVENT_ALL, NULL);
}
...
void ui_DigitalClock_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_DigitalClockPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_DigitalClockPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_DigitalClockLabel, LV_TEXT_ALIGN_LEFT,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_DigitalClockLabel, &ui_font_Roboto120,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_DigitalClockSecondLabel = lv_label_create(ui_DigitalClockPanel);
  lv_obj_set_size(ui_DigitalClockSecondLabel, 60, 40);
  lv_obj_align_to(ui_DigitalClockSecondLabel, ui_DigitalClockLabel,
                  LV_ALIGN_BOTTOM_RIGHT, 50, -3);
  lv_label_set_text(ui_DigitalClockSecondLabel, "00");
  lv_obj_set_style_text_align(ui_DigitalClockSecondLabel, LV_TEXT_ALIGN_LEFT,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_DigitalClockSecondLabel, &ui_font_Roboto45,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_DigitalClockDateLabel = lv_label_create(ui_DigitalClockPanel);
  lv_obj_set_size(ui_DigitalClockDateLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  ...
  lv_obj_set_style_text_align(ui_DigitalClockDateLabel, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_DigitalClockDateLabel, &montserrat_32,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_DigitalClockDayLabel = lv_label_create(ui_DigitalClockPanel);
  lv_obj_set_size(ui_DigitalClockDayLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  // lv_obj_set_pos(ui_DigitalClockDayLabel, 0, 115);
  lv_obj_align_to(ui_DigitalClockDayLabel, ui_DigitalClockDateLabel,
                  LV_ALIGN_OUT_RIGHT_MID, 10, -10);
  lv_label_set_text(ui_DigitalClockDayLabel, "Вс");
  lv_obj_set_style_text_align(ui_DigitalClockDayLabel, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_DigitalClockDayLabel, &montserrat_32,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_event_cb(ui_DigitalClockScreen, screen_load_event_cb,
                      LV_EVENT_SCREEN_LOADED, NULL);
  lv_obj_add_event_cb(ui_DigitalClockScreen, ui_event_DigitalClockScreen,
                      LV_EVENT_ALL, NULL);
}
void ui_Weather_screen_init(void) {
  ...
  lv_obj_set_style_text_font(ui_WeatherCity, &montserrat_18,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherTemperatureLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherTemperatureLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  ...
  lv_obj_set_style_text_font(ui_WeatherTemperatureLabel, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherFeelsLikeLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherFeelsLikeLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 121
  ...
  lv_obj_set_style_text_font(ui_WeatherFeelsLikeLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherWindLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherWindLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 121
  lv_obj_set_pos(ui_WeatherWindLabel, 140, -90);
  lv_obj_set_align(ui_WeatherWindLabel, LV_ALIGN_CENTER);
  lv_label_set_text(ui_WeatherWindLabel, "Ветер: 14.1 км/ч ЗСЗ");
  lv_obj_set_style_text_font(ui_WeatherWindLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherHumidityLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherHumidityLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 121
  // lv_obj_set_pos(ui_WeatherHumidityLabel, 140, -50);
  lv_obj_align_to(ui_WeatherHumidityLabel, ui_WeatherWindLabel,
                  LV_ALIGN_BOTTOM_LEFT, 0, 25);
  lv_label_set_text(ui_WeatherHumidityLabel, "Влажность: 75%");
  lv_obj_set_style_text_font(ui_WeatherHumidityLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherPressureLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherPressureLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 121
  lv_obj_align_to(ui_WeatherPressureLabel, ui_WeatherHumidityLabel,
                  LV_ALIGN_BOTTOM_LEFT, 0, 25);
  lv_label_set_text(ui_WeatherPressureLabel, "Давление: 1027 мбар");
  lv_obj_set_style_text_font(ui_WeatherPressureLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherBriefingLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherBriefingLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  lv_obj_set_pos(ui_WeatherBriefingLabel, 0, 30);
  lv_obj_set_align(ui_WeatherBriefingLabel, LV_ALIGN_CENTER);
  lv_label_set_text(ui_WeatherBriefingLabel,
                    "Переменная облачность. Возможен дождь.");
  lv_obj_set_style_text_font(ui_WeatherBriefingLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherMaxTempLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherMaxTempLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  ...
  lv_obj_set_style_text_font(ui_WeatherMaxTempLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherMinTempLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherMinTempLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  lv_obj_align_to(ui_WeatherMinTempLabel, ui_WeatherMaxTempLabel,
                  LV_ALIGN_OUT_RIGHT_MID, 15, -1);
  lv_label_set_text(ui_WeatherMinTempLabel, "Мин. t: -20°C");
  lv_obj_set_style_text_font(ui_WeatherMinTempLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherRainProbabLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherRainProbabLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  lv_obj_align_to(ui_WeatherRainProbabLabel, ui_WeatherMinTempLabel,
                  LV_ALIGN_OUT_RIGHT_MID, 15, -1);
  lv_label_set_text(ui_WeatherRainProbabLabel, "Вероятность осадков: 0%");
  lv_obj_set_style_text_font(ui_WeatherRainProbabLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_label_set_text(
      ui_WeatherTimesLabel,
      "Ночь               Утро               День               Вечер");
  lv_obj_set_style_text_font(ui_WeatherTimesLabel, &montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  ui_WeatherFirstTempLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherFirstTempLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  ...
  lv_obj_set_size(ui_WeatherSecondTempLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  lv_obj_align_to(ui_WeatherSecondTempLabel, ui_WeatherFirstTempLabel,
  ...
  lv_obj_set_size(ui_WeatherThirdTempLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  lv_obj_align_to(ui_WeatherThirdTempLabel, ui_WeatherSecondTempLabel,
                  LV_ALIGN_OUT_RIGHT_TOP, 65, 0);
  lv_label_set_text(ui_WeatherThirdTempLabel, "-13°C");

  ui_WeatherFourthTempLabel = lv_label_create(ui_WeatherPanel);
  lv_obj_set_size(ui_WeatherFourthTempLabel, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT); /// 1
  lv_obj_align_to(ui_WeatherFourthTempLabel, ui_WeatherThirdTempLabel,
                  LV_ALIGN_OUT_RIGHT_TOP, 65, 0);
...
void ui_Dock_init() {
  ...
  lv_obj_set_style_text_font(ui_BatteryLabel, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_opa(ui_SettingsButton, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_SettingsButtonLabel, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_event_cb(ui_SettingsButton, ui_event_SettingsButton, LV_EVENT_ALL,
                      NULL);
}
void ui_init(void) {
  lv_disp_t *dispp = lv_disp_get_default();
